    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const toolData = {
        ...
        idprint:{title:"ID Card Print",icon:"🪪"},
        idsheet:{title:"ID Card Print Sheet",icon:"🪪"},
    ...
    if(toolName==="pngpdf"){window.location.href="tools/png-to-pdf.html";return;}
    if(toolName==="pdfjpg"){window.location.href="tools/pdf-to-jpg.html";return;}
    if(toolName==="pdfpng"){window.location.href="tools/pdf-to-png.html";return;}
    if(toolName==="splitpdf"){window.location.href="tools/split-pdf.html";return;}
    if(toolName==="pdfcompressor"){window.location.href="tools/pdf-compressor.html";return;}
    if(toolName==="pdfextractor"){window.location.href="tools/pdf-page-extractor.html";return;}
        if(toolName==="jpgpdf"){window.location.href="tools/jpg-to-pdf.html";return;}
        if(toolName==="pvcautocrop"){window.location.href="tools/pvc-auto-crop.html";return;}
        if(toolName==="bgremover"){window.location.href="tools/bg-remover.html";return;}
        if(toolName==="photocropresize"){window.location.href="tools/photo-crop-resize.html";return;}
        ...
        if(toolName==="idprint"){window.location.href="tools/id-card-print.html";return;}
        if(toolName==="idsheet"){window.location.href="tools/id-card-print-sheet.html";return;}
      ...
      console.log("Manjeet Digital Hub v4.5 loaded successfully.");
    });
